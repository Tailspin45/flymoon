...
try:
    ...
    logger.warning(
        "Telegram not available. Install with: pip install python-telegram-bot"
    )
...
class WindowsTransitMonitor:
    ...
    def _create_menu(self):
        ...
        return pystray.Menu(
            ...
            pystray.MenuItem(
                lambda item: f"Interval: {self.check_interval} min", None, enabled=False
            ),
            pystray.Menu.SEPARATOR,
    ...
    def _set_target(self, target: str):
        ...
        self._send_notification(
            "🎯 Target Changed", f"Now monitoring: {target.upper()}"
        )
    ...
    def _stop_monitoring(self):
        ...
        self._send_notification(
            "🛑 Monitoring Stopped", "Transit monitoring has been stopped"
        )
