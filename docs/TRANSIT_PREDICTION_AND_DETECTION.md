# Transit Prediction and Detection (Superseded)

Superseded by [AS_BUILT_REFERENCE.md](AS_BUILT_REFERENCE.md).

For the legacy v0.1 write-up, see this file in git history.
